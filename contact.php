...
<body>
    ...
    <div class="container-fluid coinfo">
        <div class="container">
            <div class="container inbox">
                <div class="row">
                    <div class="col-lg-3 col-12 infobox">
                        <p>Address:</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 contactform">
                        <form>
                            <h5>Let's get together and talk</h5>
                            <div class="mb-3">
                            ...
                            <br>
                            <div class="mb-3">
                                <textarea id="" cols="70" rows="5" placeholder="Message"></textarea>
                            </div>
