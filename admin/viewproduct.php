...
$del = "DELETE FROM addproduct WHERE prod_id='$delid'";
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <?php
                                    $sel = "SELECT * from addproduct as p INNER JOIN addcategory as c on p.cat_id=c.cat_id";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><img  class="card-img-top" src="../upload_img/<?php echo $fetch['prod_image'] ?> "  height="150px" ></td>
                                            <td><?php echo $fetch['prod_status'] ?></td>
                                            <td><button><a href="viewproduct.php?nid=<?php echo $fetch['prod_id'] ?>">Delete</a></button> &nbsp; <button><a href="addproduct.php?edid=<?php echo $fetch['prod_id'] ?>">Edit</a></button></td>
                                        </tr>
                                    <?php }
                                    ?>
                                </tbody>
