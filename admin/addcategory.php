...
if ($editid == "") {
    if (isset($_POST['save'])) {
        ...
        $ins = "INSERT INTO addcategory SET 
        cat_name='$title',
        cat_image='$i_name',
        cat_status='$act'
    ";
    ...
    $sel = "SELECT * FROM addcategory WHERE cat_id='$editid'";
                        ...
                        <div class="card-body">
                            ...
                            <form class="mt-4 text-center" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name of Category" name="title" value="<?php echo $fetch['cat_name'] ?>">
                                </div>

                                <div class="col-lg-12 col-md-12 text-center">
                                    <div class="card">
                                        <h4 class="card-title">Category Image</h4>
                                        <input type="file" id="input-file-now" class="dropify" name="prev" value="<?php echo $fetch['cat_image'] ?> />
                                    </div>
                                </div>

                                <h4 class="card-title ">Category Status</h4>
                                <input type="radio" name="act" class="text-center" value="1" /> <span>Active</span>
                                <input type="radio" name="act" value="0" /> <span>Deactive</span><br />
