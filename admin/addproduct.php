...
if (isset($_POST['save'])) {
    ...
    $ins = "INSERT INTO addproduct SET 
        prod_name='$title',
        cat_id='$cate',
        prod_image='$i_name',
        prod_status='$act'
                        ...
                        <div class="card-body">
                            ...
                            <form class="mt-4 text-center" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name of Category" name="title">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="form-label">Category Name</label>
                                    <br>
                                    <select name="category" id="category" style="width: 1260px; height: 40px; text-align:center;" >
