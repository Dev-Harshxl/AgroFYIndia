            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="pages-login.php" aria-expanded="false"><i class="far fa-circle text-success"></i><span class="hide-menu">Log Out</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <h4 class="card-title ">Slider Status</h4>
