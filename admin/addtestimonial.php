        ...
        <div class="page-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center">Add Testimonial</h4>
                            <form class="mt-4 text-center" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-12 col-md-12 text-center">
                                    <div class="card">
                                        <h4 class="card-title">Testimonial Image</h4>
                                        <input type="file" id="input-file-now" class="dropify" name="prev" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="form-label">Testimonial Review</label>
                                    <input type="text" style="height: 150px; width:90%; padding-top:0%;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" name="para">
                                </div>
