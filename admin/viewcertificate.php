...
$del = "DELETE FROM addcerti WHERE certi_id='$delid'";
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <?php
                                    $sel = "SELECT * from addcerti";
                                    $exe = mysqli_query($conn, $sel);
                                    while ($fetch = mysqli_fetch_array($exe)) {
                                    ?>
                                        <tr>
                                            <td><input type="checkbox" value="<?php echo $fetch['id'] ?>"></td>
                                            <td><?php echo $fetch['certi_id'] ?></td>
                                            <td><?php echo $fetch['certi_name'] ?></td>
                                            <td style="width: 150px;"><img  class="card-img-top" src="../upload_img/<?php echo $fetch['certi_image'] ?> "  height="100px" ></td>
                                            <td><button><a href="viewcertificate.php?nid=<?php echo $fetch['certi_id'] ?>">Delete</a></button> &nbsp; <button><a href="addcertificate.php?edid=<?php echo $fetch['certi_id '] ?>">Edit</a></button></td>
                                        </tr>
                                    <?php }
                                    ?>
                                </tbody>
