...
$del = "DELETE FROM addslider WHERE slid_id='$delid'";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $fetch['slid_id'] ?></td>
                                            <td><?php echo $fetch['slid_title'] ?></td>
                                            <td><img src="../upload_img/<?php echo $fetch['slid_img'] ?> " style="width: 150px; height:100px;"></td>
                                            <td><?php echo $fetch['slid_stat'] ?></td>

                                            <td><button><a href="viewslider.php?nid=<?php echo $fetch['slid_id'] ?>">Delete</a></button> &nbsp; <button><a href="addslider.php?edid=<?php echo $fetch['slid_id'] ?>">Edit</a></button></td>
