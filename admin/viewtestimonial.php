...
$del = "DELETE FROM add_test WHERE test_id='$delid'";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $fetch['test_id'] ?></td>
                                            <td><?php echo $fetch['test_name'] ?></td>
                                            <td style="width: 150px;"><img  class="card-img-top" src="../upload_img/<?php echo $fetch['test_photo'] ?> "  height="100px" ></td>
                                            <td><?php echo $fetch['test_para'] ?></td>
                                            <td><button><a href="viewtestimonial.php?nid=<?php echo $fetch['test_id'] ?>">Delete</a></button> &nbsp; <button><a href="addtestimonial.php?edid=<?php echo $fetch['test_id'] ?>">Edit</a></button></td>
                                        </tr>
                                    <?php }
                                    ?>
                                </tbody>
