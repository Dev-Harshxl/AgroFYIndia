        ...
        <div class="overs">
            <div class="container">
                <div class="col-lg-12 text-center">
                    <h3><a href="index.php">Home</a> / Our Certificate</h3>
                    <h2 style="font-weight: 800;">OUR CERTIFICATE</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-lg-4 col-12">
                        <div class="card p-0 " style="width: 20rem; height: 16rem;">
                            <img class="card-img-top" src="upload_img/<?php echo $fetch['certi_image'] ?> ">
                            <div class="card-body">
                                <p class="card-text"><?php echo $fetch['certi_name'] ?></p>
                            </div>
                        </div>
                    </div>
